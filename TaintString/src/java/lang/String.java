    ...
    implements java.io.Serializable, Comparable<String>, CharSequence
{
    ...
    String(char[] paramArrayOfChar, boolean b){
        int size = paramArrayOfChar.length;
        this.offset = 0;
        this.count = size;
    ...
    public String substring(int beginIndex, int endIndex) {
        ...
        if((beginIndex == 0) && (endIndex == count)){
        	return this;
        	 ...
        	 String result = new String(offset + beginIndex, endIndex - beginIndex, value);
    ...
    public String concat(String str) {
        ...
        String result = new String(0, count + otherLen, buf);
